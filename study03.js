...
let str2 = new String("new 키워드를 사용한 방볍");
...
// length : 문자열 길이를 출력
// slice() : 문자열의 일부를 추출. 원본은 그대로 두고 새 문자열 반환
//  사용법 : 1) 새 변수 = 변수명.slice(시작 index, 끝 index); 끝 index 미포함.
//          2) 새 변수 = 변수명.slice(시작 index);
...
// substring() : slice()와 비슷한 기능.
//               slice()의 경우 index -값 사용 가능. substring()의 경우 -값 입력 시 0으로 변환하여 문자열 가져옴.
//  사용법 : 1) 새 변수 = 변수명.substring(시작 index, 끝 index);
//          2) 새 변수 = 변수명.substring(시작 index);
console.log("원본 문자열 : " + str7);
...
// substr() : slice()와 비슷한기능. 두 번째 매개변수가 추출할 문자열의 길이를 뜻함
//            두 번째 매개변수가 없으면 문자열 끝까지 가져옴
//  사용법 : 1) 새 변수 = 변수명.substr(시작 index, 글자 수);
//          2) 새 변수 = 변수명.substr(시작 index);
console.log("원본 문자열 : " + str7);
...
// replace() : 검색한 문자를 지정한 문자로 변환. 검색된 첫 번째 문자열만 변경
//             모든 문자열을 변경하려면 정규표현식을 사용해야 함.
//             원본은 그대로두고 새 문자열 반환
//  사용법 : 새 변수 = 변수명.replace(검색할 문자열, 변경할 문자열);
console.log("원본 문자열 : " + str7);
let str9 = str7.replace("바나나", "몽키바나나");
console.log("replace()사용 후 문자열 : " + str9);
str9 = str7.replace(", ", "");
...
// concat() : 2개 이상의 문자열을 하나의 긴 문자열로 합침
...
//  사용법 : 1) 새 변수 = 문자열.indexOf(검색어);
//          2) 새 변수 = 문자열.indexOf(검색어, 검색 위치);
...
//  사용법 : 1) 새 변수 = 문자열.lastIndexOf(검색어);
//          2) 새 변수 = 문자열.lastIndexOf(검색어, 검색위치);
console.log("원본 문자열 : " + str16);
...
console.log("원본 문자열 : " + str17);
let bValue = str17.includes("한라봉");
console.log("includes('한라봉')로 확인 : " + bValue);
bValue = str17.includes("귤");
console.log("includes('귤')로 확인 : " + bValue);
